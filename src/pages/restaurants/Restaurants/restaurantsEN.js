...
import { soups, main, hot, salads, desserts, drinks } from "./categories/categoriesEN.js"
...
const restaurants = [
    {
        ...
        content: {
            ...
            [drinks]: [
                { id: 12, title: "Duchess Olga", description: "Becherovka, vanilla syrup, lemon juice, raspberry puree." },
                { id: 9, title: "Dark mead", description: "" },
                { id: 10, title: "Ivan Tsarevich ale", description: "" },
                { id: 11, title: "Kikimora milk stout", description: "" },
            ]
        }
    },
    {
    ...
    },
    {
        ...
        content: {
            ...
            [drinks]: [
                { id: 7, title: "Sbiten", description: "An ancient Russian hot drink brewed from honey, spices and herbs." },
                { id: 6, title: "Mead", description: "" }
            ]
        }
    },
    {
        ...
        content: {
            ...
            [drinks]: [
                { id: 4, title: "Cloudberry", description: "Cloudberry is unlike any other berry, as nature has endowed it with a balance of sweet, sour and bitter shades of flavor. In the language of professionals, this is a tincture with a low alcohol content (low ABV), and the cocktail of ingredients in its composition gives a feeling of honey and honeycomb in the aftertaste." },
                { id: 5, title: "Horseradish", description: "First-rate aromatic horseradish, six kinds of piquant peppers, garlic, natural honey and a long infusion." }
            ]
    ...
    },
    {
        ...
        content: {
            ...
            [drinks]: [
                { id: 6, title: "Vodka Spasskaya", description: "" },
                { id: 7, title: "Vodka Sadko", description: "" },
                { id: 8, title: "Spotykatch", description: "" }
            ]
        }
    },
    {
